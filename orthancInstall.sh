...
wget -O Orthanc-1.5.8.tar.gz https://www.orthanc-server.com/downloads/get.php?path=/orthanc/Orthanc-1.5.8.tar.gz
tar zxvf Orthanc-1.5.8.tar.gz
rm Orthanc-1.5.8.tar.gz
mkdir OrthancBuild
cd OrthancBuild
cmake /home/bin/Orthanc-1.5.8 -DALLOW_DOWNLOADS=ON -DUSE_GOOGLE_TEST_DEBIAN_PACKAGE=ON -DUSE_SYSTEM_CIVETWEB=OFF -DDCMTK_LIBRARIES=dcmjpls -DCMAKE_BUILD_TYPE=Release
make
echo "en_US.UTF-8 UTF-8" > /etc/locale.gen
locale-gen
rm -rf /home/bin/Orthanc-1.5.8
...
cd /home/bin/
wget -O OrthancWebViewer-2.5.tar.gz https://www.orthanc-server.com/downloads/get.php?path=/plugin-webviewer/OrthancWebViewer-2.5.tar.gz
tar zxvf OrthancWebViewer-2.5.tar.gz
rm OrthancWebViewer-2.5.tar.gz
...
make
rm -rf /home/bin/OrthancWebViewer-2.5
