...
wget -O Orthanc-1.9.4.tar.gz https://www.orthanc-server.com/downloads/get.php?path=/orthanc/Orthanc-1.9.4.tar.gz
tar zxvf Orthanc-1.9.4.tar.gz
...
locale-gen
rm -rf /home/bin/Orthanc-1.9.4

cd /home/bin/
wget -O OrthancPostgreSQL-4.0.tar.gz https://www.orthanc-server.com/downloads/get.php?path=/plugin-postgresql/OrthancPostgreSQL-4.0.tar.gz
tar zxvf OrthancPostgreSQL-4.0.tar.gz
rm OrthancPostgreSQL-4.0.tar.gz
mkdir PostgreSQLBuild
cd PostgreSQLBuild
cmake /home/bin/OrthancPostgreSQL-4.0/PostgreSQL -DSTATIC_BUILD=ON -DCMAKE_BUILD_TYPE=Release
make
rm -rf /home/bin/OrthancPostgreSQL-4.0
...
cd /home/bin/
wget -O OrthancWebViewer-2.7.tar.gz https://www.orthanc-server.com/downloads/get.php?path=/plugin-webviewer/OrthancWebViewer-2.7.tar.gz
tar zxvf OrthancWebViewer-2.7.tar.gz
rm OrthancWebViewer-2.7.tar.gz
mkdir OrthancWebViewerBuild
cd OrthancWebViewerBuild
cmake /home/bin/OrthancWebViewer-2.7 -DSTATIC_BUILD=ON -DCMAKE_BUILD_TYPE=Release
make
rm -rf /home/bin/OrthancWebViewer-2.7

cd /home/bin/
wget -O OrthancDicomWeb-1.6.tar.gz https://www.orthanc-server.com/downloads/get.php?path=/plugin-dicom-web/OrthancDicomWeb-1.6.tar.gz
tar zxvf OrthancDicomWeb-1.6.tar.gz
rm OrthancDicomWeb-1.6.tar.gz
mkdir DicomWebBuild
cd DicomWebBuild
cmake /home/bin/OrthancDicomWeb-1.6 -DSTATIC_BUILD=ON -DCMAKE_BUILD_TYPE=Release
make
rm -rf /home/bin/OrthancDicomWeb-1.6
